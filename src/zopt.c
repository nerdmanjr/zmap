/*
  ...
  gengetopt -C --no-help --no-version --unamed-opts=SUBNETS -i /opt/zmap/src/zopt.ggo -F /opt/zmap/src/zopt 
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -F, --fingerprint-file=name   Output file for operating system finger print",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->fingerprint_file_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->fingerprint_file_arg = NULL;
  args_info->fingerprint_file_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->interface_help = gengetopt_args_info_help[23] ;
  args_info->vpn_help = gengetopt_args_info_help[24] ;
  args_info->probe_module_help = gengetopt_args_info_help[26] ;
  args_info->output_module_help = gengetopt_args_info_help[27] ;
  args_info->probe_args_help = gengetopt_args_info_help[28] ;
  args_info->output_args_help = gengetopt_args_info_help[29] ;
  args_info->output_filter_help = gengetopt_args_info_help[30] ;
  args_info->list_output_modules_help = gengetopt_args_info_help[31] ;
  args_info->list_probe_modules_help = gengetopt_args_info_help[32] ;
  args_info->list_output_fields_help = gengetopt_args_info_help[33] ;
  args_info->config_help = gengetopt_args_info_help[35] ;
  args_info->log_file_help = gengetopt_args_info_help[36] ;
  args_info->log_directory_help = gengetopt_args_info_help[37] ;
  args_info->quiet_help = gengetopt_args_info_help[38] ;
  args_info->summary_help = gengetopt_args_info_help[39] ;
  args_info->fingerprint_file_help = gengetopt_args_info_help[40] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->fingerprint_file_arg));
  free_string_field (&(args_info->fingerprint_file_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->fingerprint_file_given)
      write_into_file(outfile, "fingerprint-file", args_info->fingerprint_file_orig, 0);
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "p:o:b:w:f:n:N:t:r:B:c:e:T:P:ds:S:G:i:XM:O:C:l:L:qgF:v:hV", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'F':	/* Finger print  */
          ...
          if (update_arg( (void *)&(args_info->fingerprint_file_arg),
               &(args_info->fingerprint_file_orig), &(args_info->fingerprint_file_given),
               &(local_args_info.fingerprint_file_given), optarg, 0, 0, ARG_STRING,
               check_ambiguity, override, 0, 0,
               "fingerprint-file", 'F',
               additional_error))
           goto failure;
